$(document).ready(function(){
	...
	initAutocomplete(cardimage, function(data){
		...
		console.log("uri: ", data.front.scryfall_uri);
		document.getElementById('imgref').href = data.front.scryfall_uri + "#rulings";
		// cardimageRep.value = data.image_uris.border_crop;
		cardRep.value = data;
	});
